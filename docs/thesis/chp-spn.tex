...
probability of evidence from an SPN by computing $P(X=x)=S(x)/S(\ast)$.
...
distribution, taking a value of 1 if it agrees with the given evidence and zero otherwise.
